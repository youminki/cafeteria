    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      ...
      >
        <div className="p-12 text-center">
          ...
          <h1 className="text-3xl font-black text-slate-900 tracking-tighter uppercase mb-2">cafeteria</h1>
          <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-12">Smart Dining System</p>
          ...
          <div className="mt-12 pt-12 border-t border-slate-100">
            <p className="text-[10px] font-bold text-slate-300 uppercase tracking-widest leading-relaxed">
              본 시스템은 사내 식당 좌석 예약 및 현황 파악을 위한 전용 시스템입니다.
            </p>
          </div>
        </div>
      </motion.div>
